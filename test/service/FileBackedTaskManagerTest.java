...
public class FileBackedTaskManagerTest extends ManagersTest<FileBackedTaskManager> {
    File file;
    File emptyFile;
    Path emptyFilePath = Path.of("emptyTestFile.csv");
    Path path = Path.of("testFile.csv");
    FileBackedTaskManager fileManager;
    FileBackedTaskManager emptyFileManager;
    ...
    void init() {
        ...
        emptyFile = new File(String.valueOf(emptyFilePath));
        emptyFileManager = new FileBackedTaskManager(emptyFile);
    }
